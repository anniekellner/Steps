...
shp <- shp_names[49] # CHANGE THIS TO INSTALLATION OF INTEREST
...
point_matrix <- matrix(c(x, y), nrow = 1, ncol = 2)
# Extract value at point
elevation_value <- terra::extract(elev_raster, point_matrix)[1, 2]
