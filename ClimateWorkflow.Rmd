...
rx <- readRDS(file = "N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/Eielson_AFB/rasterStack_Eielson_AFB_EC-Earth3-Veg-LR_20250327.Rds") #INSERT COPY-PASTED PATH TO .RDS FILE
...
rasterStack_filename <- paste0("rasterStack_",image_filename,".tif")
...
writeRaster(rx, filename = paste0(rawDataDir,"/",rasterStack_filename), overwrite = TRUE) # save raster stack to N: drive
