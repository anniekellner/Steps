...
#shp <- shp_names[58] # CHANGE THIS TO INSTALLATION OF INTEREST
...
#load("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/Luke_AFB_FTRA/Luke_AFB_FTRA_EC-Earth3-Veg-LR_20250926.RData") # INSERT COPY-PASTED PATH TO .RDATA FILE

# Load raster stack

#rx <- readRDS("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/Luke_AFB_FTRA/rasterStack_Luke_AFB_FTRA_EC-Earth3-Veg-LR_20250926.Rds") #INSERT COPY-PASTED PATH TO .TIF FILE
...
official_name <- official_base_names[40] # These names serve as titles for the climograph and Walter-Lieth plots
...
list.files(path = NOAA_dir, pattern = "611_-_King_Salmon_Airport")
...
weather_station_filename <- "611_-_King_Salmon_Airport.csv" #paste0(weather_station,".csv")
...
centroidElev <- geom(centroids(base_spatVect, inside = TRUE)) # Different longitude scale (-180,180)
...
elev <- as.numeric(terra::extract(elevRast, centroidElev_matrix)[1,])
