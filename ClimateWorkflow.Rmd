...
#shp <- shp_names[48] # CHANGE THIS TO INSTALLATION OF INTEREST
...
official_name <- official_base_names[30] # These names serve as titles for the climograph and Walter-Lieth plots
...
list.files(path = NOAA_dir, pattern = "Luke_Aux")
...
weather_station <- "Luke_Aux_Air_Field" # this is usually the shp name
