...
shp <- shp_names[42] # CHANGE THIS TO INSTALLATION OF INTEREST
...
load("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/BMGR_West/BMGR_West_EC-Earth3-Veg-LR_20250820.RData") # INSERT COPY-PASTED PATH TO .RDATA FILE

# Load raster stack

rx <- rast("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/BMGR_West/rasterStack_BMGR_West_EC-Earth3-Veg-LR_20250820.Rds") #INSERT COPY-PASTED PATH TO .RDS FILE
...
writeRaster(rxCrop, filename = paste0(rawDataDir,"/",rasterStack_filename), overwrite = TRUE) # save raster stack to N: drive
