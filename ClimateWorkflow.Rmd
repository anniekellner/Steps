...
official_name <- official_base_names[41] # These names serve as titles for the climograph and Walter-Lieth plots
...
weather_station <- "NWS_Yorktown" #shp # this is usually the shp name
