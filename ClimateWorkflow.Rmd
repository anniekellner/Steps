...
elevRaster <- rast(elevRaster)
elevRaster <- project(elevRaster, "EPSG:4326")


# Single row matrix: columns are x (lon) and y (lat)
point_matrix <- matrix(c(baseSF$lon, baseSF$lat), nrow = 1, ncol = 2)
# Extract value at point
elevation_value <- terra::extract(elevRaster, point_matrix)[1, 2]
