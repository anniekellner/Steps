...
shp <- shp_names[33] # CHANGE THIS TO INSTALLATION OF INTEREST
...
#load("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/Creech_AFB/Creech_AFB_EC-Earth3-Veg-LR_20250318.RData") # INSERT COPY-PASTED PATH TO .RDATA FILE

# Load raster stack

#rx <- readRDS(file = "N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/Creech_AFB/rasterStack_Creech_AFB_EC-Earth3-Veg-LR_20250318.Rds") #INSERT COPY-PASTED PATH TO .RDS FILE
...
official_name <- official_base_names[4] # These names serve as titles for the climograph and Walter-Lieth plots
...
list.files(path = NOAA_dir, pattern = "NellisAFB")
...
weather_station <- "NellisAFB_CorrectedDaymet" # this is usually the shp name
weather_station_filename <- paste0(weather_station,".csv")

noaa_dataFilepath <- "NellisAFB_CorrectedDaymet.csv" #paste0(NOAA_dir, weather_station_filename)
...
Now that we've extracted and formatted the model data, we can remove extraneous variables from the environment and run the observed historical analysis. 
