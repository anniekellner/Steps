...
official_name <- official_base_names[36] # These names serve as titles for the climograph and Walter-Lieth plots
...
list.files(path = NOAA_dir, pattern = "NS_Norfolk")
...
weather_station <- "NS_Norfolk" # this is usually the shp name
