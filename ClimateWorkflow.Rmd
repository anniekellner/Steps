...
#shp <- shp_names[39] # CHANGE THIS TO INSTALLATION OF INTEREST
...
official_name <- official_base_names[18] # These names serve as titles for the climograph and Walter-Lieth plots
...
weather_station <- "JBMDL" # this is usually the shp name
...
rm(list=setdiff(ls(), c("monthSumDF", 
                        "shp", 
                        "model", 
                        "official_name",
                        "scenarios",
