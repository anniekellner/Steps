...
shp <- shp_names[52] # CHANGE THIS TO INSTALLATION OF INTEREST
...
load("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/Travis_AFB/Travis_AFB_ACCESS-ESM1-5_20251210.RData") # INSERT COPY-PASTED PATH TO .RDATA FILE

# Load raster stack

rx <- rast("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/Travis_AFB/rx_Travis_AFB_ACCESS-ESM1-5_20251210.tif") #INSERT COPY-PASTED PATH TO .RDS FILE
...
rm(list = ls(pattern = "^sf", pattern = "^afb", lf))
