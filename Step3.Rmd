...
# If for some reason the AllDays object does not work, you can use the script './Code/Misc/MonthSum.R' to run the MonthSum analyses using the csv output files

rm(list=setdiff(ls(), "AllDays"))
