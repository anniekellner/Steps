...
title = official_name
  ...
  sub_placement = 78 - sub_length - per_length # 1 in = 12 spaces, so a 6.5" in width image contains 78 spaces per line. This right-aligns the "subtitle" (i.e., the righthand temp/precip values)
