...
cat(paste("The official name for the installation you are running is",official_name,".","The abbreviated name for the installation shapefile is", shp,"and the general ancroym associated with the installation is", base_abbrev,"."))
