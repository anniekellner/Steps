...
installation <- installation_names[24] 
...
source('./Code/Plots/Bar_Charts/Hist_Bar_Charts.R')
source('./Code/Plots/Bar_Charts/Compare_Bar_Charts.R')
source('./Code/Plots/Bar_Charts/Format_Bar_Charts.R')
