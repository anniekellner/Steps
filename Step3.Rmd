...
results_folder = paste0('N:/RStor/mindyc/afccm/Climate Modeling/Results_',model,"/",AFB_Name,"/") 
```
...
*If you want to override the automatic choice, manually enter either of the following options into the CONSOLE:* (if you enter it into the code chunk it will remain there and you risk overriding future choices you may not want to)

**extract_obj <- cell** to use the centroid  -OR-
**extract_obj <- afb** to use the entire shapefile

(Do not include the **; I inserted those to change the color of the text to highlight what is code vs. text for readability)
