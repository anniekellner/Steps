...
AFB_Name <- "Guam_Proxy_v1" # Can create a vector similar to 'models' above if desired
...
#rx <- raster(stackS1F1_v1[[1]]) # for plotting and getting basic raster info
...
tmap_leaflet(
tm_shape(as(rxCrop, "Raster")) + 
  tm_raster() + 
  tm_shape(as(afb, "spatial")) + 
  tm_borders())
...
rxCellSize <- cellSize(rxCrop, unit = "km")
