...
library(fs) # for cross-platform names
library(conflicted)
...
wl_dir <- paste0(results_folder,"Plots/","Walter-Lieth")
...
filename = paste0(AFB_Name,"_",model,"_WLDiagram_",wl_scenario,".png")
filepath = paste(wl_dir,filename, sep = "/")
...
# Create Fahrenheit dataframe for plot tags
