...
Typically the analysis portion would follow the user entries, but because the historical analysis uses a different dataset from the rest of the script, we are running it before adding settings that pertain to later stages of the analysis.
