...
First, let's *select which base (AFB) and model you wish to run.*  To choose from a list, highlight the word `AFB_Names` and/or `models` (including the ``) and click 'Run' at the top right (or use the shortcut "Ctrl + Enter"). The available models correspond to numbers in the vector (e.g., HADGEM2-ES is [1]). 
...
ggsave(filenameC, plot = wlCplot, device = png, path = wl_dir, width = 4.5, height = 6.5, units = "in", dpi = 300)
...
ggsave(filenameF, plot = wlFplot, device = png, path = wl_dir, width = 4.5, height = 6.5, units = "in", dpi = 300)
