...
This section creates WL Diagrams for both F and C and places the results in the results_folder (under Plots/Walter-Lieth)
...
wlCplot = wlCplot + theme(text=element_text(family="serif")) # serif = Times New Roman 
