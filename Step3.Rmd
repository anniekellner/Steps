...
**NOTE: Only run the next chunk (clear-workspace) if necessary. Code is commented out to avoid accidentally clearing the workspace. If you un-comment to clear the workspace, please remember to reinsert the # to comment it back out. 
...
source('./Code/Functions/WL_Adapted.R') # Walter-Lieth plots
...
AFB_Name <- AFB_Names[17] 

official_name <- official_base_names_for_plots[1]
