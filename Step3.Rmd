...
dir_installation_boundaries <- ifelse(Navy == FALSE, # site boundary (shapefile used for clipping)
                      "/Volumes/wcnr-network-1/RStor/CEMML/ClimateChange/CC_Modeling/Data/Spatial/Installation_Boundaries/",
                      "/Volumes/wcnr-network-1/RStor/CEMML/ClimateChange/CC_Modeling/Data/Spatial/Installation_Boundaries/NAVY")
...
model_dir <- paste("/Volumes/wcnr-network-1/RStor/CEMML/ClimateChange/CC_Modeling/Data/Spatial/", model, sep = "") 
...
list.files(path = paste0('/Volumes/wcnr-network/RStor/mindyc/afccm/Climate Modeling/Workspace Images/',installation), full.names = TRUE) ## MAC ONLY
...
load("/Volumes/wcnr-network/RStor/mindyc/afccm/Climate Modeling/Workspace Images/CapeCanaveral_45th/CapeCanaveral_45th_EC-Earth3-Veg-LR_20240927.RData" )

# Load raster stack

rx <- readRDS(file = "/Volumes/wcnr-network/RStor/mindyc/afccm/Climate Modeling/Workspace Images/CapeCanaveral_45th/rasterStack_CapeCanaveral_45th_EC-Earth3-Veg-LR_20240927.Rds")
