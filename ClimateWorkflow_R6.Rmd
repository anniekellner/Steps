...
**ANOTHER NOTE: If you are running a base that was run prior to June 2026, you may see a .Rds or .tif file listed beneath the .RData file. You can ignore that. Also ignore the error; it was related to the .Rds or .tif file**
...
#load("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/611_-_Indian_Mountain/611_-_Indian_Mountain_ACCESS-ESM1-5_20260610.RData") # INSERT COPY-PASTED PATH TO .RDATA FILE
...
*NOTE TO SELF: Have to amend axes to account for mismatch in size between temp and precip. Also deal with margin argument*
