...
#shp <- shp_names[62] # CHANGE THIS TO INSTALLATION OF INTEREST
...
#load("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/611_-_Cold_Bay_Long_Range_Radar_Site/611_-_Cold_Bay_Long_Range_Radar_Site_ACCESS-ESM1-5_20260507.RData") # INSERT COPY-PASTED PATH TO .RDATA FILE

# Load raster stack

#rx <- rast("N:/RStor/CEMML/ClimateChange/CC_Modeling/Data/Workspace Images/611_-_Cold_Bay_Long_Range_Radar_Site/rx_611_-_Cold_Bay_Long_Range_Radar_Site_ACCESS-ESM1-5_20260507.tif") #INSERT COPY-PASTED PATH TO .TIF FILE
...
official_name <- official_base_names[45] # These names serve as titles for the climograph and Walter-Lieth plots
...
# Remove unnecessary objects (these cause problems)
...
rx_filename <- paste0("rx_",image_filename,".tif")
...
writeRaster(rxCrop, filename = paste0(rawDataDir,"/",rx_filename), overwrite = TRUE) # save raster stack to N: drive
...
noaa_resultsDir <- paste0("N:/RStor/CEMML/ClimateChange/CC_Modeling/Results/Results_NOAA_Hist/", "611_-_King_Salmon_Airport")
